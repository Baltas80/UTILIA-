...
void main() {
  group('UTILIA calculations', () {
    ...
    test(
      'compound zero years returns principal',
      () => expect(compound(1000, 10, 0), 1000),
    );
    test(
      'compound non-finite input is safe',
    ...
    test(
      'cost per km zero distance is safe',
      () => expect(costPerKm(45, 0), 0),
    );

    test(
      'BMI uses height in centimetres',
    ...
    test('date difference', () {
      expect(
        dateDifferenceDays(DateTime(2026, 1, 1), DateTime(2026, 1, 11)),
        10,
      );
      expect(
        dateDifferenceDays(DateTime(2026, 1, 11), DateTime(2026, 1, 1)),
        10,
      );
      expect(
        dateDifferenceDays(DateTime(2024, 2, 28), DateTime(2024, 3, 1)),
        2,
      );
    });
    ...
    test(
      'negative resulting work hours are safe',
      () => expect(workHours(8, 8, 60), 0),
    );
    test(
      'work hours non-finite input is safe',
