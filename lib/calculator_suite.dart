...
class _CalculatorSuitePageState extends State<CalculatorSuitePage> {
  ...
  void key(String value) {
    setState(() {
      ...
      if (value == '=') { try { result = _format(CalculatorParser(expression, degrees: degrees).parse()); _saveResult(); } catch (_) { result = t('Error', 'Error', 'Erreur', 'Fehler', 'Errore', 'Erro'); } return; }
