...
class UtiliaStrings {
  ...
  static const _tools = <String, List<String>>{
    ...
    'discount': [
      'Descuentos',
      'Calcular el precio final tras un descuento',
      'Discounts',
    ...
    'iva': [
      'IVA',
      'Añadir IVA a un precio',
      'VAT',
      'Add VAT to a price',
      'TVA',
      'Ajouter la TVA à un prix',
      'MwSt.',
      'Mehrwertsteuer zu einem Preis hinzufügen',
      'IVA',
    ...
    'tip': [
      'Propinas',
      'Calcular una propina y repartir el total',
      'Tips',
      'Calculate a tip and split the total',
      'Pourboires',
      'Calculer un pourboire et partager le total',
      'Trinkgeld',
      'Trinkgeld berechnen und Gesamtbetrag teilen',
      'Mance',
    ...
    'loan': [
      ...
      'Prêts',
      'Calculer une mensualité de prêt',
      'Kredite',
      'Eine monatliche Kreditrate berechnen',
      'Prestiti',
    ...
    'compoundInterest': [
      'Interés compuesto',
      'Calcular el crecimiento con interés compuesto',
      'Compound interest',
      'Calculate growth with compound interest',
      'Intérêts composés',
      'Calculer une croissance avec intérêts composés',
      'Zinseszins',
      'Wachstum mit Zinseszins berechnen',
      'Interesse composto',
    ...
    'workHours': [
      'Horas trabajadas',
      'Calcular las horas trabajadas descontando pausas',
      'Work hours',
      'Calculate worked hours after breaks',
      'Heures travaillées',
      'Calculer les heures travaillées après les pauses',
      'Arbeitszeit',
      'Arbeitszeit nach Pausen berechnen',
      'Ore lavorate',
    ...
    'countdown': [
      ...
      'Compte à rebours',
      'Convertir heures, minutes et secondes en secondes',
      'Countdown',
      'Stunden, Minuten und Sekunden in Sekunden umrechnen',
      'Conto alla rovescia',
    ...
    'area': [
      'Superficie',
      'Calcular el área de una superficie rectangular',
      'Area',
      'Calculate rectangular surface area',
      'Surface',
      'Calculer une surface rectangulaire',
      'Fläche',
      'Rechteckige Fläche berechnen',
      'Area',
    ...
    'paint': [
      'Pintura',
      'Estimar los litros de pintura necesarios',
      'Paint',
      'Estimate litres of paint needed',
      'Peinture',
      'Estimer les litres de peinture nécessaires',
      'Farbe',
      'Benötigte Liter Farbe schätzen',
      'Vernice',
    ...
    'electricity': [
      'Consumo eléctrico',
      'Estimar el coste de la electricidad',
      'Electricity',
    ...
    'fuel': [
      'Combustible',
      'Calcular el coste de combustible de un viaje',
      'Fuel',
      'Calculate fuel cost for a trip',
      'Carburant',
      'Calculer le coût du carburant d’un trajet',
      'Kraftstoff',
      'Kraftstoffkosten einer Fahrt berechnen',
      'Carburante',
    ...
    'length': [
      ...
      'Convertir entre unités de longueur',
      'Längenumrechner',
    ...
    'weight': [
      'Conversor de peso',
      'Convertir entre unidades de peso',
      'Weight converter',
    ...
    'gradeAverage': [
      'Media de notas',
      'Calcular la media de varias notas',
      'Grade average',
      'Calculate the average of several grades',
      'Moyenne des notes',
      'Calculer la moyenne de plusieurs notes',
      'Notendurchschnitt',
      'Durchschnitt mehrerer Noten berechnen',
      'Media dei voti',
    ...
    'ruleOfThree': [
      'Regla de tres',
      'Resolver un cálculo proporcional',
      'Rule of three',
      'Solve a proportional calculation',
      'Règle de trois',
      'Résoudre un calcul proportionnel',
      'Dreisatz',
      'Eine proportionale Rechnung lösen',
      'Regola del tre',
    ...
    'calculator': [
      'Calculadora',
      'Calculadora rápida con teclado numérico',
      'Calculator',
      'Fast calculator with numeric keypad',
      'Calculatrice',
      'Calculatrice rapide avec pavé numérique',
      'Rechner',
      'Schneller Rechner mit Ziffernblock',
      'Calcolatrice',
    ...
    'scientificCalculator': [
      ...
      'Funciones trigonométricas y matemáticas avanzadas',
      'Scientific calculator',
      'Trigonometric and advanced mathematical functions',
      'Calculatrice scientifique',
      'Fonctions trigonométriques et mathématiques avancées',
      'Wissenschaftlicher Rechner',
      'Trigonometrische und erweiterte mathematische Funktionen',
