...
class UtiliaBrand {
  ...
  static Color categoryColor(String category, Color fallback) =>
      categoryColors[category] ?? fallback;
}
...
class UtiliaMountainArtwork extends StatelessWidget {
  const UtiliaMountainArtwork({super.key, this.borderRadius = 18});
...
class _MountainPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final far = Path()
      ...
      ..lineTo(size.width * .34, size.height * .66)
      ..lineTo(size.width * .50, size.height * .28)
      ..lineTo(size.width * .67, size.height * .62)
      ..lineTo(size.width * .84, size.height * .50)
    ...
    final near = Path()
      ...
      ..lineTo(size.width * .40, size.height * .76)
      ..lineTo(size.width * .56, size.height * .43)
      ..lineTo(size.width * .73, size.height * .73)
    ...
    final snow = Path()
      ...
      ..lineTo(size.width * .49, size.height * .40)
      ..lineTo(size.width * .55, size.height * .47)
      ..lineTo(size.width * .57, size.height * .39)
      ..close();
    ...
    for (var i = 0; i < 7; i++) {
      ...
      final p = Path()
        ..moveTo(x, y)
        ..lineTo(x + size.width * .025, y - size.height * .10)
