        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [tint, tint.withValues(alpha: .70)]),
            ...
            child: Row(
              children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(s.category(category), style: const TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w900)), const SizedBox(height: 4), Text(s.toolsCount(tools.length), style: TextStyle(color: Colors.white.withValues(alpha: .88), fontWeight: FontWeight.w600))])),
              ],
            ),
          ),
  ...
  Widget _toolCard(BuildContext context, UtiliaTool tool) {
    ...
    return Card(
      child: InkWell(
        ...
        onTap: () => openUtiliaTool(context, tool, storage, onHistory, s),
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(s.toolName(tool.type.name, tool.name), style: Theme.of(context).textTheme.titleMedium), const SizedBox(height: 4), Text(s.toolDescription(tool.type.name, tool.description), maxLines: 2, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.bodyMedium)])),
