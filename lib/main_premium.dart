...
class _UtiliaHomePageState extends State<UtiliaHomePage> {
  ...
  String get _appSubtitle => switch (s.selectedLanguage) { UtiliaLanguage.en => 'Tools for everyday life', UtiliaLanguage.fr => 'Des outils pour votre quotidien', UtiliaLanguage.de => 'Werkzeuge für den Alltag', UtiliaLanguage.it => 'Strumenti per la vita quotidiana', UtiliaLanguage.pt => 'Ferramentas para o dia a dia', _ => 'Herramientas para tu día a día' };
  String get _benefitUseful => switch (s.selectedLanguage) { UtiliaLanguage.en => 'Useful', UtiliaLanguage.fr => 'Utile', UtiliaLanguage.de => 'Nützlich', UtiliaLanguage.it => 'Utile', UtiliaLanguage.pt => 'Útil', _ => 'Útil' };
  String get _benefitSimple => switch (s.selectedLanguage) { UtiliaLanguage.en => 'Simple', UtiliaLanguage.fr => 'Simple', UtiliaLanguage.de => 'Einfach', UtiliaLanguage.it => 'Semplice', UtiliaLanguage.pt => 'Simples', _ => 'Simple' };
  String get _benefitAlways => switch (s.selectedLanguage) { UtiliaLanguage.en => 'Always with you', UtiliaLanguage.fr => 'Toujours avec vous', UtiliaLanguage.de => 'Immer bei dir', UtiliaLanguage.it => 'Sempre con te', UtiliaLanguage.pt => 'Sempre consigo', _ => 'Siempre contigo' };
  String get _favoriteSubtitle => switch (s.selectedLanguage) { UtiliaLanguage.en => 'Your favorite tools, always at hand.', UtiliaLanguage.fr => 'Vos outils préférés, toujours à portée de main.', UtiliaLanguage.de => 'Ihre Lieblingswerkzeuge immer griffbereit.', UtiliaLanguage.it => 'I tuoi strumenti preferiti, sempre a portata di mano.', UtiliaLanguage.pt => 'As suas ferramentas favoritas, sempre à mão.', _ => 'Tus herramientas favoritas, siempre a mano.' };
  String get _privacyTitle => switch (s.selectedLanguage) { UtiliaLanguage.en => 'Privacy', UtiliaLanguage.fr => 'Confidentialité', UtiliaLanguage.de => 'Datenschutz', UtiliaLanguage.it => 'Privacy', UtiliaLanguage.pt => 'Privacidade', _ => 'Privacidad' };
  String get _privacySubtitle => switch (s.selectedLanguage) { UtiliaLanguage.en => 'Your data, your control', UtiliaLanguage.fr => 'Vos données, votre contrôle', UtiliaLanguage.de => 'Ihre Daten, Ihre Kontrolle', UtiliaLanguage.it => 'I tuoi dati, il tuo controllo', UtiliaLanguage.pt => 'Os seus dados, o seu controlo', _ => 'Tus datos, tu control' };
  String get _aboutTitle => switch (s.selectedLanguage) { UtiliaLanguage.en => 'About', UtiliaLanguage.fr => 'À propos', UtiliaLanguage.de => 'Über', UtiliaLanguage.it => 'Informazioni', UtiliaLanguage.pt => 'Sobre', _ => 'Acerca de' };
  @override void initState() { super.initState(); _load(); }
  ...
  Widget _benefits() => Row(children: [_benefit(Icons.bolt_rounded, _benefitUseful), const SizedBox(width: 7), _benefit(Icons.favorite_border_rounded, _benefitSimple), const SizedBox(width: 7), _benefit(Icons.all_inclusive_rounded, _benefitAlways)]);
