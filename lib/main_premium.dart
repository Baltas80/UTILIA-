...
class _UtiliaHomePageState extends State<UtiliaHomePage> {
  ...
  PreferredSizeWidget _topBar() => AppBar(
        ...
        actions: [IconButton(onPressed: () => showAboutDialog(context: context, applicationName: 'UTILIA', applicationVersion: '0.5.1', applicationLegalese: s.slogan), icon: const Icon(Icons.info_outline_rounded)), const SizedBox(width: 10)],
      );
